...
namespace HGSystem.Helpers
{
    ...
    ///<param name="e"></param>
    public delegate void WebClientUploadEvent(object sender, HGSystem.Helpers.UploadEventArgs e);
    ...
    ///<param name="sender"></param>
    ///<param name="e"></param>
    public delegate void WebClientDownloadEvent(object sender, HGSystem.Helpers.DownloadEventArgs e);
