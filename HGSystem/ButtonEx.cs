 ...
 */
    ...
    public class ButtonEx : Button
    {
        ...
        private TextFormatFlags GetTextFormatFlags(ContentAlignment ta, bool isrtl)
        {
            TextFormatFlags flags = new TextFormatFlags();
            if (ta == ContentAlignment.BottomCenter)
                flags = TextFormatFlags.Bottom | TextFormatFlags.HorizontalCenter;
            else if (ta == ContentAlignment.BottomLeft)
                flags = TextFormatFlags.Bottom | TextFormatFlags.Left;
            else if (ta == ContentAlignment.BottomRight)
                flags = TextFormatFlags.Bottom | TextFormatFlags.Right;
            else if (ta == ContentAlignment.MiddleCenter)
                flags = TextFormatFlags.VerticalCenter | TextFormatFlags.HorizontalCenter;
            else if (ta == ContentAlignment.MiddleLeft)
                flags = TextFormatFlags.VerticalCenter | TextFormatFlags.Left;
            else if (ta == ContentAlignment.MiddleRight)
                flags = TextFormatFlags.VerticalCenter | TextFormatFlags.Right;
            else if (ta == ContentAlignment.TopCenter)
                flags = TextFormatFlags.Top | TextFormatFlags.HorizontalCenter;
            else if (ta == ContentAlignment.TopLeft)
                flags = TextFormatFlags.Top | TextFormatFlags.Left;
            else if (ta == ContentAlignment.TopRight)
